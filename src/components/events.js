          ...
          return (
            <Link to={`/event/${edge.node.slug}`}>
              <Card style={{ width: '18rem' }} className={ eventsStyles.event }>
                <Card.Img variant="top" src="https://images.unsplash.com/photo-1582807129843-8a00296ccb37?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=768&q=80/100px180" />
                  <Card.Body>
